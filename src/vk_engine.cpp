...
void VulkanEngine::draw()
{
    ...
    VkSemaphoreSubmitInfo signalInfo = vkinit::semaphore_submit_info(VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT,
                                                                     _imageRenderSemaphores[swapchainImageIndex]);
    ...
    presentInfo.pWaitSemaphores = &_imageRenderSemaphores[swapchainImageIndex];
...
void VulkanEngine::rebuild_swapchain()
{
    ...
    VkWriteDescriptorSet cameraWrite =
        vkinit::write_descriptor_image(VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, _drawImageDescriptors, &imgInfo, 0);
